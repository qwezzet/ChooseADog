...
public class TwoActivity extends AppCompatActivity {
    ...
    private void setupData() {
        ...
        State avstrovch = new State("0", "25",nm[0], snm[0], dsc[0], R.drawable.avstr);
        stateList.add(avstrovch);
        State akitainu = new State("1","25", nm[1], snm[1], dsc[1], R.drawable.akita);
        stateList.add(akitainu);
        State americstafford = new State("2","26", nm[2], snm[2], dsc[2], R.drawable.am_staff);
        stateList.add(americstafford);
        State englbulldog = new State("3","34", nm[3], snm[3], dsc[3], R.drawable.bull);
        stateList.add(englbulldog);
        State bassethaund = new State("4","36", nm[4], snm[4], dsc[4], R.drawable.bassh);
        stateList.add(bassethaund);
        State burnzennen = new State("5","26", nm[5], snm[5], dsc[5], R.drawable.zennen);
        stateList.add(burnzennen);
        State bigl = new State("6","35", nm[6], snm[6], dsc[6], R.drawable.bigl);
        stateList.add(bigl);
        State velshkorgi = new State("7","25", nm[7], snm[7], dsc[7], R.drawable.korgi);
        stateList.add(velshkorgi);
        State vesteuovcharka = new State("8","16", nm[8], snm[8], dsc[8], R.drawable.vesteuov);
        stateList.add(vesteuovcharka);
        State gavanbishon = new State("9","35", nm[9], snm[9], dsc[9], R.drawable.gavbish);
        stateList.add(gavanbishon);
        State dolmatin = new State("10","16", nm[10], snm[10], dsc[10], R.drawable.dolm);
        stateList.add(dolmatin);
        State doberman = new State("11","14", nm[11], snm[11], dsc[11], R.drawable.dober);
        stateList.add(doberman);
        State zapadsiblaika = new State("12","16", nm[12], snm[12], dsc[12], R.drawable.zaplaika);
        stateList.add(zapadsiblaika);
        State goldretriver = new State("13","26", nm[13], snm[13], dsc[13], R.drawable.retriv);
        stateList.add(goldretriver);
        State irelandvolkodav = new State("14","25", nm[14], snm[14], dsc[14], R.drawable.volkod);
        stateList.add(irelandvolkodav);
        State spanishmastif = new State("15","14", nm[15], snm[15], dsc[15], R.drawable.spmast);
        stateList.add(spanishmastif);
        State iorkterrer = new State("16","35", nm[16], snm[16], dsc[16], R.drawable.ioterr);
        stateList.add(iorkterrer);
        State kavkazovcharka = new State("17","14", nm[17], snm[17], dsc[17], R.drawable.kavov);
        stateList.add(kavkazovcharka);
        State kanecorso = new State("18","14", nm[18], snm[18], dsc[18], R.drawable.kane);
        stateList.add(kanecorso);
        State chinahohl = new State("19","35", nm[19], snm[19], dsc[19], R.drawable.chhohl);
        stateList.add(chinahohl);
        State komandor = new State("20","15", nm[20], snm[20], dsc[20], R.drawable.koman);
        stateList.add(komandor);
        State labladorretr = new State("21","26", nm[21], snm[21], dsc[21], R.drawable.labret);
        stateList.add(labladorretr);
        State leonberger = new State("22","14", nm[22], snm[22], dsc[22], R.drawable.leon);
        stateList.add(leonberger);
        State maltabalon = new State("23","35", nm[23], snm[23], dsc[23], R.drawable.balon);
        stateList.add(maltabalon);
        State mops = new State("24","35", nm[24], snm[24], dsc[24], R.drawable.mops);
        stateList.add(mops);
        State doichovcharka = new State("25","14", nm[25], snm[25], dsc[25], R.drawable.dovch);
        stateList.add(doichovcharka);
        State doichbokser = new State("26","14", nm[26], snm[26], dsc[26], R.drawable.bokser);
        stateList.add(doichbokser);
        State doichdog = new State("27","24", nm[27], snm[27], dsc[27], R.drawable.ddog);
        stateList.add(doichdog);
        State newfoundland = new State("28","14", nm[28], snm[28], dsc[28], R.drawable.newf);
        stateList.add(newfoundland);
        State pekines = new State("29","35", nm[29], snm[29], dsc[29], R.drawable.pekines);
        stateList.add(pekines);
        State pomeranskshpic = new State("30","35", nm[30], snm[30], dsc[30], R.drawable.pspic);
        stateList.add(pomeranskshpic);
        State pudel = new State("31","25", nm[31], snm[31], dsc[31], R.drawable.pudel);
        stateList.add(pudel);
        State rizenshaunzer = new State("32","26", nm[32], snm[32], dsc[32], R.drawable.rizen);
        stateList.add(rizenshaunzer);
        State rotveiler = new State("33","14", nm[33], snm[33], dsc[33], R.drawable.rotv);
        stateList.add(rotveiler);
        State russianborzya = new State("34","16", nm[34], snm[34], dsc[34], R.drawable.rusborz);
        stateList.add(russianborzya);
        State russiantoi = new State("35","35", nm[35], snm[35], dsc[35], R.drawable.rustoi);
        stateList.add(russiantoi);
        State samoed = new State("36","25", nm[36], snm[36], dsc[36], R.drawable.samoed);
        stateList.add(samoed);
        State senbernar = new State("37","24", nm[37], snm[37], dsc[37], R.drawable.senbr);
        stateList.add(senbernar);
        State taksa = new State("38","35", nm[38], snm[38], dsc[38], R.drawable.taksa);
        stateList.add(taksa);
        State tibetskimastif = new State("39","14", nm[39], snm[39], dsc[39], R.drawable.tibmast);
        stateList.add(tibetskimastif);
        State uippet = new State("40","35", nm[40], snm[40], dsc[40], R.drawable.uippet);
        stateList.add(uippet);
        State pharaondog = new State("41","26", nm[41], snm[41], dsc[41], R.drawable.phar);
        stateList.add(pharaondog);
        State francebulldog = new State("42","35", nm[42], snm[42], dsc[42], R.drawable.frbull);
        stateList.add(francebulldog);
        State hovavart = new State("43","26", nm[43], snm[43], dsc[43], R.drawable.hova);
        stateList.add(hovavart);
        State cvergshnaucer = new State("44","35", nm[44], snm[44], dsc[44], R.drawable.cvergs);
        stateList.add(cvergshnaucer);
        State chauchau = new State("45","25", nm[45], snm[45], dsc[45], R.drawable.chch);
        stateList.add(chauchau);
        State blackterrer = new State("46","26", nm[46], snm[46], dsc[46], R.drawable.blterr);
        stateList.add(blackterrer);
        State chihuahua = new State("47","35", nm[47], snm[47], dsc[47], R.drawable.chihua);
        stateList.add(chihuahua);
        State sharpay = new State("48","35", nm[48], snm[48], dsc[48], R.drawable.sharp);
        stateList.add(sharpay);
        State shitsu = new State("49","35", nm[49], snm[49], dsc[49], R.drawable.shitsu);
        stateList.add(shitsu);
        State elderterrer = new State("50","36", nm[50], snm[50], dsc[50], R.drawable.elterr);
        stateList.add(elderterrer);
        State dogwithblmouth = new State("51","16", nm[51], snm[51], dsc[51], R.drawable.blmouth);
        stateList.add(dogwithblmouth);
        State japanesexin = new State("52","35", nm[52], snm[52], dsc[52], R.drawable.jxin);
        stateList.add(japanesexin);
        State japaneseshpic = new State("53","35", nm[53], snm[53], dsc[53], R.drawable.jspic);
    ...
    private void filterList(String status) {
        ...
        ArrayList<State> filteredStates = new ArrayList<>();
        for (State state : stateList) {
            if (state.getFiltid().toLowerCase().contains(status)) {
    ...
    public void bigbtn(View view) {filterList("1"); }
    ...
    public void oxotbtn(View view) { filterList("6"); }
