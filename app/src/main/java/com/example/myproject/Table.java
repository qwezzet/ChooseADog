...
public class Table extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backtomain.setOnClickListener(new View.OnClickListener() {
            ...
            aboutsizes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void showAlertDialogInform1(View v){
        ...
        alert.setPositiveButton("Скрыть", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(Table.this,"Удачного выбора!", Toast.LENGTH_SHORT).show();
            }
        });
        alert.create().show();
    }
    ...
    public void showAlertDialogDesk(View v){
        ...
        alert.setPositiveButton("Скрыть", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(Table.this,"Спасибо за понимание!", Toast.LENGTH_LONG).show();
            }
        });
        alert.create().show();
    }
